...
loadPosts();});$('.buttons-list__button.clean').on("click",function(){$('.filter-list input[value="all"]').prop('checked',true);$('.filter-list input[type="checkbox"]').not('[value="all"]').prop('checked',false);$(this).hide();categories=['all'];});$('.buttons-list__button').not('.clean').on('click',function(){loadPosts();(0,_utils__WEBPACK_IMPORTED_MODULE_5__.hideBackdrop)(_refs__WEBPACK_IMPORTED_MODULE_4__["default"].filterBackdrop);});}),"./assets/js/popups/filter.js":
/*!************************************!*\
...
/*! ./filter */
"./assets/js/popups/filter.js");}),"./assets/js/popups/menu.js":
/*!**********************************!*\
