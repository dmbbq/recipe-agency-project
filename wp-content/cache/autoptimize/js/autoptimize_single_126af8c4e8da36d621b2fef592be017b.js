...
var slideIndex=$(e.target).text();if($(e.currentTarget.closest('.blog-page-swiper')).hasClass('desk')){blogPageSwiper.slideTo(slideIndex-1,0);}else{blogPageSwiperMob.slideTo(slideIndex-1,0);}};var handleNavigationClick=function handleNavigationClick(e){if($(e.currentTarget).hasClass('first')){blogPageSwiper.slideTo(0,0);}else if($(e.currentTarget).hasClass('last')){blogPageSwiper.slideTo(blogPageSwiper.slides.length-1,0);}};_refs__WEBPACK_IMPORTED_MODULE_3__["default"].blogSwiperNavigation.on("click",handleNavigationClick);_refs__WEBPACK_IMPORTED_MODULE_3__["default"].blogSwiperPagination.on("click",handlePaginationClick);var singleBlogSwiper=new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.single-blog-swiper',{spaceBetween:35,slidesPerView:3});}),"./assets/js/utils.js":
/*!****************************!*\
  !*** ./assets/js/utils.js ***!
  \****************************/
