(()=>{var __webpack_modules__=({"./assets/js/menu.js":
/*!***************************!*\
  !*** ./assets/js/menu.js ***!
  \***************************/
...
/*! lodash.throttle */
"./node_modules/lodash.throttle/index.js");var lodash_throttle__WEBPACK_IMPORTED_MODULE_4___default=__webpack_require__.n(lodash_throttle__WEBPACK_IMPORTED_MODULE_4__);var aboutSwiper=new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.about-swiper',{centeredSlides:true,spaceBetween:5,slidesPerView:1,grabCursor:true,loop:true,breakpoints:{992:{centeredSlides:false,slidesPerView:3},1440:{slidesPerView:4,centeredSlides:false,spaceBetween:15}}});var partnersSwiperTop=new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.partners-swiper-top',{loop:true,allowTouchMove:false,speed:4000,slidesPerView:3,spaceBetween:10,autoplay:{delay:0},breakpoints:{992:{slidesPerView:4},1440:{slidesPerView:5},1920:{slidesPerView:6}}});var partnersSwiperBottom=new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.partners-swiper-bottom',{loop:true,allowTouchMove:false,slidesPerView:3,spaceBetween:10,speed:4000,autoplay:{delay:0,reverseDirection:true},breakpoints:{992:{slidesPerView:4},1440:{slidesPerView:5},1920:{slidesPerView:6}}});var teamSwiper=new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.team-swiper',{spaceBetween:7,slidesPerView:1,grabCursor:true,navigation:{nextEl:".team-section .next",prevEl:".team-section .prev"},breakpoints:{768:{slidesPerView:2},992:{slidesPerView:3},1200:{slidesPerView:4,spaceBetween:20},1920:{slidesPerView:4,spaceBetween:20}}});var blogPageSwiper=new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.blog-page-swiper',{spaceBetween:70,slidesPerView:1,autoHeight:true,allowTouchMove:false,navigation:{prevEl:".blog-page-swiper .prev",nextEl:".blog-page-swiper .next"},pagination:{el:'.blog-page-swiper .swiper-pagination',renderBullet:_utils_js__WEBPACK_IMPORTED_MODULE_2__.renderEllipsisBullet},on:{slideChange:function slideChange(){this.pagination.render();}}});var handlePaginationClick=function handlePaginationClick(e){if(e.target===e.currentTarget||e.target.classList.contains('swiper-pagination-bullet-ellipsis')){return;}
var slideIndex=$(e.target).text();blogPageSwiper.slideTo(slideIndex-1,0);};var handleNavigationClick=function handleNavigationClick(e){if(e.currentTarget.classList.contains('first')){blogPageSwiper.slideTo(0,0);}else if(e.currentTarget.classList.contains('last')){blogPageSwiper.slideTo(blogPageSwiper.slides.length-1,0);}};_refs__WEBPACK_IMPORTED_MODULE_3__["default"].blogSwiperNavigation.on("click",handleNavigationClick);_refs__WEBPACK_IMPORTED_MODULE_3__["default"].blogSwiperPagination.on("click",handlePaginationClick);var singleBlogSwiper=new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.single-blog-swiper',{spaceBetween:35,slidesPerView:3});}),"./assets/js/utils.js":
/*!****************************!*\
  !*** ./assets/js/utils.js ***!
  \****************************/
...
var replaceInputWithButton=function replaceInputWithButton(){var submitInput=$('.wpcf7-form [type="submit"]');var value=submitInput.val();submitInput.prop("outerHTML",function(){return this.outerHTML.replace(/input/gi,"button");});var newButton=$('.wpcf7-form [type="submit"]');newButton.text(value);newButton.attr("data-text",value);};var initSwiperClasses=function initSwiperClasses(){swiperToInit.each(function(){var currentElement=$(this);var replaceWithDiv=function replaceWithDiv(selector,className){currentElement.find(selector).replaceWith(function(){return $('<div>',{"class":className,html:$(this).html()});});};replaceWithDiv('dl','swiper-slide');currentElement.find('style, br').remove();currentElement.find('div').addClass('swiper-wrapper');});};initSwiperClasses();function renderEllipsisBullet(index,className){var swiper=this;var total=swiper.slides.length;var current=swiper.realIndex;var numberOfBullets=2;var isWithinRange=index>=current-numberOfBullets&&index<=current+numberOfBullets;var isActive=index===current?'swiper-pagination-bullet-active':'';if(index===0||index===total-1||isWithinRange){return"<span class=\"".concat(className," ").concat(isActive,"\" role=\"button\" tabindex=\"0\" aria-label=\"Go to slide ").concat(index+1,"\">").concat(index+1,"</span>");}
if(index===numberOfBullets&&current-numberOfBullets>numberOfBullets-1){return'<span class="swiper-pagination-bullet-ellipsis">...</span>';}
if(index===total-numberOfBullets-1&&current+numberOfBullets<total-numberOfBullets-1){return'<span class="swiper-pagination-bullet-ellipsis">...</span>';}
return'';}
$("document").ready(function(){bodyEl.css("visibility","visible");new wowjs_dist_wow_min__WEBPACK_IMPORTED_MODULE_6__.WOW().init();replaceInputWithButton();});}),"./node_modules/lodash.throttle/index.js":
/*!***********************************************!*\
...
/*! ../internals/is-object */
"./node_modules/core-js/internals/is-object.js");var $String=String;var $TypeError=TypeError;module.exports=function(argument){if(isObject(argument))return argument;throw new $TypeError($String(argument)+' is not an object');};}),"./node_modules/core-js/internals/array-from.js":
/*!******************************************************!*\
...
A.length=n;return A;}});}),"./node_modules/core-js/modules/es.array.find.js":
/*!*******************************************************!*\
...
"./node_modules/core-js/internals/check-correctness-of-iteration.js");var INCORRECT_ITERATION=!checkCorrectnessOfIteration(function(iterable){Array.from(iterable);});$({target:'Array',stat:true,forced:INCORRECT_ITERATION},{from:from});}),"./node_modules/core-js/modules/es.array.is-array.js":
/*!***********************************************************!*\
...
switch(state.kind){case'keys':return createIterResultObject(index,false);case'values':return createIterResultObject(target[index],false);}return createIterResultObject([index,target[index]],false);},'values');var values=Iterators.Arguments=Iterators.Array;addToUnscopables('keys');addToUnscopables('values');addToUnscopables('entries');if(!IS_PURE&&DESCRIPTORS&&values.name!=='values')try{defineProperty(values,'name',{value:'values'});}catch(error){}}),"./node_modules/core-js/modules/es.array.slice.js":
/*!********************************************************!*\
...
result=new(Constructor===undefined?$Array:Constructor)(max(fin-k,0));for(n=0;k<fin;k++,n++)if(k in O)createProperty(result,n,O[k]);result.length=n;return result;}});}),"./node_modules/core-js/modules/es.date.to-string.js":
/*!***********************************************************!*\
...
/*! ./showMore */
"./assets/js/showMore.js");var _menu__WEBPACK_IMPORTED_MODULE_4__=__webpack_require__(
/*! ./menu */
"./assets/js/menu.js");var _swiper__WEBPACK_IMPORTED_MODULE_5__=__webpack_require__(
/*! ./swiper */
"./assets/js/swiper.js");var _css_main_scss__WEBPACK_IMPORTED_MODULE_6__=__webpack_require__(
/*! ../css/main.scss */
"./assets/css/main.scss");})();})();