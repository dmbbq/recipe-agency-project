...
return'';}
$('#single-case .hero-content__button').on("click",function(){var textToCopy=$('#single-case .hero-content__link a').attr('href');navigator.clipboard.writeText(textToCopy);});$('a[href="privacy_policy_url"]').attr('href',custom_vars.privacy_policy_url);console.log($('a[href="privacy_policy_url"]'));$("document").ready(function(){bodyEl.css("visibility","visible");new wowjs_dist_wow_min__WEBPACK_IMPORTED_MODULE_6__.WOW().init();replaceInputWithButton();});}),"./node_modules/lodash.throttle/index.js":
/*!***********************************************!*\
