...
var closestCtaWrapper=element.closest('div.cta-wrapper');return closestCtaWrapper.find('h2');};var cf7TitleInputs=$('.cf7-form-title');cf7TitleInputs.each(function(){var closestH2=findClosestH2($(this));$(this).val(closestH2.text());});var btnUp={el:document.querySelector('.btn-up'),show:function show(){this.el.classList.remove('btn-up_hide');},hide:function hide(){this.el.classList.add('btn-up_hide');},addEventListener:function addEventListener(){var _this=this;window.addEventListener('scroll',function(){var scrollY=window.scrollY||document.documentElement.scrollTop;scrollY>400?_this.show():_this.hide();});this.el.onclick=function(){window.scrollTo({top:0,left:0,behavior:'smooth'});};}};btnUp.addEventListener();btnUp.addEventListener();$("document").ready(function(){bodyEl.css("visibility","visible");new wowjs_dist_wow_min__WEBPACK_IMPORTED_MODULE_6__.WOW().init();replaceInputWithButton();});}),"./node_modules/lodash.throttle/index.js":
/*!***********************************************!*\
