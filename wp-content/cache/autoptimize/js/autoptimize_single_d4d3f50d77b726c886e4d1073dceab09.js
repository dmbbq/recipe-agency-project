...
console.log(e.target);var slideIndex=$(e.target).text();blogPageSwiper.slideTo(slideIndex-1,0);};var handleNavigationClick=function handleNavigationClick(e){if(e.currentTarget.classList.contains('first')){blogPageSwiper.slideTo(0,0);}else if(e.currentTarget.classList.contains('last')){blogPageSwiper.slideTo(blogPageSwiper.slides.length-1,0);}};_refs__WEBPACK_IMPORTED_MODULE_3__["default"].blogSwiperNavigation.on("click",handleNavigationClick);_refs__WEBPACK_IMPORTED_MODULE_3__["default"].blogSwiperPagination.on("click",handlePaginationClick);var singleBlogSwiper=new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.single-blog-swiper',{spaceBetween:35,slidesPerView:3});}),"./assets/js/utils.js":
/*!****************************!*\
  !*** ./assets/js/utils.js ***!
  \****************************/
