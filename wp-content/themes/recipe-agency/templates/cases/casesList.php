...
if ($query->have_posts()) {
    ...
    <div class="swiper cases-page-swiper desk d-none d-md-block">
        ...
        <?php
                    $paginationClass = ($lists_count > 1) ? 'd-flex justify-content-center' : 'd-none';
                    $pagination_visibility = ($lists_count > 4) ? '' : 'd-none';
                    get_template_part('templates/pagination', null, array('class' => $paginationClass, 'ctrl' => $pagination_visibility));
        ?>
    </div>
