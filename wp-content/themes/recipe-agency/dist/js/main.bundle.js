...
loadPosts();
var updateCategories = function updateCategories(category, isChecked) {
  var index = categories.indexOf(category);
  var indexOfAll = categories.indexOf('all');
  if (category === 'all') {
    if (!isChecked) {
...
/* harmony import */ var _refs__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../refs */ "./assets/js/refs.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../utils */ "./assets/js/utils.js");
/* harmony import */ var _filterPosts__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../filterPosts */ "./assets/js/filterPosts.js");
/* harmony import */ var lodash_throttle__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! lodash.throttle */ "./node_modules/lodash.throttle/index.js");
...
var filterBackdrop = _refs__WEBPACK_IMPORTED_MODULE_14__["default"].filterBackdrop,
  filterButton = _refs__WEBPACK_IMPORTED_MODULE_14__["default"].filterButton;
var handleClick = function handleClick() {
  filterBackdrop.hasClass("is-hidden") ? (0,_utils__WEBPACK_IMPORTED_MODULE_15__.showBackdrop)(filterBackdrop, true) : (0,_utils__WEBPACK_IMPORTED_MODULE_15__.hideBackdrop)(filterBackdrop);
};
filterButton.on("click", lodash_throttle__WEBPACK_IMPORTED_MODULE_17___default()(handleClick, 400));
    ...
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      if (mutation.type === "attributes" && mutation.attributeName === "class") {
        ...
        if (filterBackdrop.hasClass('is-hidden')) {
          (0,_filterPosts__WEBPACK_IMPORTED_MODULE_16__.loadPosts)();
        }
      }
    }
  } catch (err) {
...
observer.observe(filterBackdrop[0], {
  attributes: true
});
...
/* harmony import */ var _refs__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../refs */ "./assets/js/refs.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../utils */ "./assets/js/utils.js");
/* harmony import */ var lodash_throttle__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! lodash.throttle */ "./node_modules/lodash.throttle/index.js");
...
var menuBackdrop = _refs__WEBPACK_IMPORTED_MODULE_14__["default"].menuBackdrop,
  menuButton = _refs__WEBPACK_IMPORTED_MODULE_14__["default"].menuButton,
  menuNavLinks = _refs__WEBPACK_IMPORTED_MODULE_14__["default"].menuNavLinks;
var handleClick = function handleClick() {
  menuBackdrop.hasClass("is-hidden") ? (0,_utils__WEBPACK_IMPORTED_MODULE_15__.showBackdrop)(menuBackdrop, true) : (0,_utils__WEBPACK_IMPORTED_MODULE_15__.hideBackdrop)(menuBackdrop);
};
menuButton.on("click", lodash_throttle__WEBPACK_IMPORTED_MODULE_16___default()(handleClick, 400));
menuNavLinks.on("click", function () {
  return (0,_utils__WEBPACK_IMPORTED_MODULE_15__.hideBackdrop)(menuBackdrop);
});
var observer = new MutationObserver(function (mutationsList, observer) {
  var _iterator = _createForOfIteratorHelper(mutationsList),
    _step;
...
/* harmony import */ var _refs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./refs */ "./assets/js/refs.js");
...
var aboutSwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.about-swiper', {
  centeredSlides: true,
  spaceBetween: 5,
  slidesPerView: 1,
  grabCursor: true,
...
var partnersSwiperBottom = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.partners-swiper-bottom', {
  loop: true,
  allowTouchMove: false,
  slidesPerView: 3,
  spaceBetween: 10,
...
var teamSwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.team-swiper', {
  spaceBetween: 7,
  slidesPerView: 1,
  grabCursor: true,
  navigation: {
...
var blogPageSwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.blog-page-swiper.desk', {
  spaceBetween: 70,
  slidesPerView: 1,
  autoHeight: true,
  allowTouchMove: false,
  ...
  pagination: {
    ...
    renderBullet: _utils_js__WEBPACK_IMPORTED_MODULE_2__.renderEllipsisBullet
  },
  on: {
...
var blogPageSwiperMob = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.blog-page-swiper.mob', {
  spaceBetween: 70,
  slidesPerView: 1,
  autoHeight: true,
  allowTouchMove: false,
...
/* harmony export */   hideBackdrop: () => (/* binding */ hideBackdrop),
/* harmony export */   renderEllipsisBullet: () => (/* binding */ renderEllipsisBullet),
/* harmony export */   showBackdrop: () => (/* binding */ showBackdrop)
/* harmony export */ });
...
/* harmony import */ var wowjs_dist_wow_min__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! wowjs/dist/wow.min */ "./node_modules/wowjs/dist/wow.min.js");
/* harmony import */ var wowjs_dist_wow_min__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(wowjs_dist_wow_min__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _refs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./refs */ "./assets/js/refs.js");
...
var bodyEl = _refs__WEBPACK_IMPORTED_MODULE_7__["default"].bodyEl,
  swiperToInit = _refs__WEBPACK_IMPORTED_MODULE_7__["default"].swiperToInit;
var throttledHandleResize = lodash_throttle__WEBPACK_IMPORTED_MODULE_5___default()(handleResize, 200);
...
var initSwiperClasses = function initSwiperClasses() {
...
initSwiperClasses();
function renderEllipsisBullet(index, className) {
  var swiper = this;
  var total = swiper.slides.length;
  var current = swiper.realIndex;
  var numberOfBullets = 2;
  var isWithinRange = index >= current - numberOfBullets && index <= current + numberOfBullets;
  var isActive = index === current ? 'swiper-pagination-bullet-active fw-medium d-inline-flex align-items-center justify-content-center' : '';
  if (index === 0 || index === total - 1 || isWithinRange) {
    return "<span class=\"".concat(className, " fw-medium d-inline-flex align-items-center justify-content-center ").concat(isActive, "\" role=\"button\" tabindex=\"0\" aria-label=\"Go to slide ").concat(index + 1, "\">").concat(index + 1, "</span>");
  }
...
/* harmony import */ var _showMore__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./showMore */ "./assets/js/showMore.js");
/* harmony import */ var _popups__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./popups */ "./assets/js/popups/index.js");
/* harmony import */ var _swiper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./swiper */ "./assets/js/swiper.js");
/* harmony import */ var _filterPosts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./filterPosts */ "./assets/js/filterPosts.js");
