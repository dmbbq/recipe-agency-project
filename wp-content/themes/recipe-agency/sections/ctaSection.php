...
$image_url_mob = $args['image_url_mob'] ?? get_field('cta_image_mob');

$is_mailing = is_page(pll_get_post(124, $current_lang)) || is_singular('blog');
?>

<section class="section section--padding" id="cta">
    <div class="container">
        <div class="cta-wrapper <?= $page; ?>">
            ...
            <?php else: ?>
                ...
                <p class="cta-link mb-0">
                    ...
                    <a class="fw-medium" href="<?= get_permalink(pll_get_post(283)); ?>">
...
<style>
    .cta-wrapper {
        background-image: url(<?= $image_url_mob; ?>);
    }
